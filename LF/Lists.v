...
Fixpoint bigthan_nat (n m : nat) : bool :=
  match n with
  | O => false
  | S n' =>
      match m with
...
Fixpoint nonzeros (l:natlist) : natlist :=
  match l with
  | nil => nil
  | x :: xs => match bigthan_nat x 0 with
                | true => x :: nonzeros xs
                | false => nonzeros xs
              end
end.
...
Example test_remove_one:
  remove_one 5 [2;1;5;4;1] = [2;1;4;1].
Proof.
  simpl. reflexivity.
Qed.

Example test_remove_no_one:
  remove_one 5 [2;1;4;1] = [2;1;4;1].
Proof.
  simpl. reflexivity.
Qed.
...
Example test_remove_all:  remove_all 5 [2;1;5;4;5;1] = [2;1;4;1].
Proof.
  simpl. reflexivity.
Qed.
